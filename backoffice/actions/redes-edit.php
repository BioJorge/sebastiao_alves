...
<?php
    ...
    if(isset($_GET["id"])){
        ...
        iduSQL("UPDATE redes_sociais SET facebook='$_GET[facebook]', instagram='$_GET[instagram]', linkedin='$_GET[linkedin]', data_atualizacao='$data' WHERE id='$id'");
    ...
    <body>
        ...
        <main>
            <div class="container-fluid opcoes_edicao flex-column d-flex justify-content-center align-items-center mt-3">
                <form action="" method="GET" id="formulario" class="d-flex flex-column align-items-center justify-content-center">

                    <h3>Facebook</h3>
                    <input type="text" name="facebook" value="<?=$redes_edicao["facebook"]?>">

                    <h3>Instagram</h3>
                    <input type="text" name="instagram" value="<?=$redes_edicao["instagram"]?>">

                    <h3>LinkedIn</h3>
                    <input type="text" name="linkedin" value="<?=$redes_edicao["linkedin"]?>">
