...
<html lang="pt">
    ...
    <head>
        ...
        <!--CSS proprio-->
        <link rel="stylesheet" href="backoffice/public/backoffice.css">
    </head>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="text-sci">
                        ...
                        <p>
                            ...
                            <br><br>
                            <b style="color: #B47D33;">email: </b> fabricio@codemaster.pt
                            <br>
                            <b style="color: #B47D33;">senha: </b> teste
                        </p>
                ...
                <div class="logreg-box">
                    <div class="form-box login">
                        <form action="backoffice/login.php" method="POST" class="formulario">
                            <h2>Sign In</h2>

                            <?php if(!empty($_GET["credenciais"])):?>
                                <h3 style="color: #B47D33; text-align: center;">Credencais de acesso inválidas</h3>
                            <?php endif; ?>
                            ...
                            <div class="login-register">
                                <p>Don't have an account? <a href="backoffice/sign_up.php">Sign up</a></p>
                            </div>
